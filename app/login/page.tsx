...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (userData && userData.password === loginData.password.trim()) {
                ...
                (async () => {
                    try {
                        await subscribePushNotification(userData.username);
                    } catch (e) {
                        console.log('Error sinkronisasi device saat login:', e);
                    }
                })();
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            (async () => {
                try {
                    await subscribePushNotification(newUser.username);
                } catch (e) {
                    console.log('Error sinkronisasi device saat registrasi:', e);
                }
            })();
