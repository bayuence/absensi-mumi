...
export default function Navbar() {
    ...
    useEffect(() => {
        ...
        // Jangan redirect dari Navbar - biarkan halaman masing-masing yang handle
    ...
    const handleLogout = () => {
        localStorage.clear();
        // Gunakan window.location untuk hard redirect, avoid caching issues
                        ...
                        <div className="hidden md:flex items-center space-x-1">
                            {navLinks.map((link) => (
                                <Link
                                    key={link.href}
                                    href={link.href}
                                    className={`relative px-4 py-2 rounded-xl font-medium text-sm transition-all duration-300 group ${currentPath === link.href
                        ...
                        <div className="px-4 py-4 pb-6 space-y-2">
                            ...
                            {navLinks.map((link, index) => (
                                <Link
                                    ...
                                    href={link.href}
                                    onClick={() => setIsMenuOpen(false)}
                                    className={`flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-300 ${currentPath === link.href
